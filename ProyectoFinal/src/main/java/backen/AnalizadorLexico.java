            ...
            if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
                ...
                switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                    ...
                    case 20:
                        break;
                    case 4: {
                        anañirTokenSignos(yytext());
                        anañirTextoAceptado(yytext());
                    }
                    // fall through
                    case 21:
                        break;
                    case 5: {
                        anañirTokenAritmeticos(yytext());
                        anañirTextoAceptado(yytext());
                    }
                    // fall through
                    case 22:
                    ...
                    case 24:
                        break;
                    case 8: {
                        anañirTokenIdentificador(yytext());
                        anañirTextoAceptado(yytext());
                    }
                    // fall through
                    case 25:
